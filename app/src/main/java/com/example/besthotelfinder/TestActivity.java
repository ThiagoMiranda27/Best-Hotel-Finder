...
public class TestActivity extends Activity /*AppCompatActivity*/ /*implements View.OnClickListener*/ {
...
//        dataInicio = new DatePickerDialog.OnDateSetListener() {
//            @Override
//            public void onDateSet(DatePicker datePicker, int inicio_year, int inicio_month, int inicio_day) {
//                Calendar c = Calendar.getInstance();
//
//                c.set(Calendar.YEAR, inicio_year);
//                c.set(Calendar.MONTH, inicio_month);
//                c.set(Calendar.DAY_OF_MONTH, inicio_day);
//
//                String date = DateFormat.getDateInstance().format(c.getTime());
//
//                TextView tvDataEntrada = findViewById(R.id.tv_dataEntrada);
//                tvDataEntrada.setText(date);
//
...
//    dataFim = new DatePickerDialog.OnDateSetListener() {
//        @Override
//        public void onDateSet(DatePicker datePicker, int fim_year, int fim_month, int day) {
//                Calendar c = Calendar.getInstance();
//
//                c.set(Calendar.YEAR, fim_year);
//                c.set(Calendar.MONTH, fim_month);
//                c.set(Calendar.DAY_OF_MONTH, day);
//
//                String date = DateFormat.getDateInstance().format(c.getTime());
//
//                TextView tvDataSaida = findViewById(R.id.tv_dataSaida);
//                tvDataSaida.setText(date);
//
//                DialogFragment dataPicker = new DataPicker();
//                dataPicker.show(getSupportFragmentManager(), "DataPicker");
//
...
//        switch (v.getId()){
//
//            case R.id.btn_DataEntrada:
//                onDateSet(year,month,day);
//                TextView tvEntrada = findViewById(R.id.tv_dataEntrada);
//                tvEntrada.setText(date);
//
//            case R.id.btn_DataSaida:
//
//        }
//
//
...
//                c.set(Calendar.DAY_OF_MONTH, day);
//                String date = DateFormat.getDateInstance().format(c.getTime());
//                TextView tvSaida = findViewById(R.id.tv_dataSaida);
//                tvSaida.setText(date);
//                DialogFragment dataPicker = new DataPicker();
//                dataPicker.show(getSupportFragmentManager(), "DataPicker");